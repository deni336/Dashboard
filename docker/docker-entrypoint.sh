...
mkdir -p "$CONFIG_DIR/kasugai/logs" /app/kasugai/resources
...
set_value("AI", "model", os.getenv("OPENAI_MODEL", "gpt-5.6-sol"))
...
chmod 700 "$CONFIG_DIR" "$CONFIG_DIR/kasugai" "$CONFIG_DIR/kasugai/logs" /app/kasugai/resources
